...
namespace DDCloud.Platform.WebApi
{
		...
		: IHttpRequestBuilder<TContext>
	{
		...
		///		The new <see cref="HttpRequestBuilder{TContext}"/>.
		/// </returns>
		public HttpRequestBuilder<TContext> WithQueryParameter<T>(string name, Func<TContext, T> getValue)
		{
		...
		///		The new <see cref="HttpRequestBuilder{TContext}"/>.
		/// </returns>
		public HttpRequestBuilder<TContext> WithQueryParameter<T>(string name, Func<T> getValue)
		{
			if (String.IsNullOrWhiteSpace(name))
				throw new ArgumentException("Argument cannot be null, empty, or composed entirely of whitespace: 'name'.", "name");
		...
		///		The new <see cref="HttpRequestBuilder{TContext}"/>.
		/// </returns>
		public HttpRequestBuilder<TContext> WithTemplateParameter<T>(string name, Func<TContext, T> getValue)
		{
			if (String.IsNullOrWhiteSpace(name))
				throw new ArgumentException("Argument cannot be null, empty, or composed entirely of whitespace: 'name'.", "name");
		...
		///		The new <see cref="HttpRequestBuilder{TContext}"/>.
		/// </returns>
		public HttpRequestBuilder<TContext> WithTemplateParameter<T>(string name, Func<T> getValue)
		{
			if (String.IsNullOrWhiteSpace(name))
				throw new ArgumentException("Argument cannot be null, empty, or composed entirely of whitespace: 'name'.", "name");
		...
		IDictionary<string, string> GetTemplateParameterValues(TContext context)
		{
			return
				_templateParameters.Select(
					templateParameter =>
					{
						Debug.Assert(templateParameter.Value != null, "templateParameter.Value != null");
